...
/**
 * The settings form body, shared by the desktop dialog and the mobile drawer.
 ...
 * seeded on mount (the dialog/drawer remounts this on open).
 */
    ...
    <div className="flex flex-col gap-5">
      <div className="flex flex-col gap-1.5">
        ...
        <p className="text-xs text-muted-foreground">
          Submissions are POSTed here as signed JSON. Leave empty to only store
          them.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <p className="text-xs text-muted-foreground">
          Signs the <code>X-Ketrone-Signature</code> header so your backend can
      ...
      <div className="flex flex-col gap-1.5">
        ...
        />
        <p className="text-xs text-muted-foreground">
          One per line. Only these domains may load and submit this form. Leave
          empty to allow any.
        </p>
      </div>
    </div>
...
/**
 * Desktop header entry point: a "Settings" button that opens the form's backend
 * integration settings in a dialog. On mobile the same fields are shown in a
 * drawer (see ProjectEditor).
 */
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <FormSettingsFields settings={settings} onChange={onChange} />
      </DialogContent>
    </Dialog>
  )
}
